...
public class Champscreen extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		item1 = (Button) findViewById(R.id.Champ1);
		item2 = (Button) findViewById(R.id.Champ2);
		item3 = (Button) findViewById(R.id.Champ3);
		item4 = (Button) findViewById(R.id.Champ4);
		item5 = (Button) findViewById(R.id.Champ5);
		item6 = (Button) findViewById(R.id.Champ6);
		Intent i = getIntent();
